...
_JOB = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='valid', full_name='Job.valid', index=11,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='add_vals', full_name='Job.add_vals', index=12,
...
_EXPERIMENT_PARAMETERSPEC = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='group', full_name='Experiment.ParameterSpec.group', index=6,
